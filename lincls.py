...
def main():
    ...
    pretrained_dir = os.path.join(args.save_dir, 'ckpts/')

    epochs = ['000', '010', '020', '030', '040', '050', '060', '070', '080', '090',
        '100', '110', '120', '130', '140', '150', '160', '170', '180', '190',
        '200', '210', '220', '230', '240', '250', '260', '270', '280', '290',
        '300', '310', '320', '330', '340', '350', '360', '370', '380', '390', '399'
    ]
    for epoch in epochs:
        args.pretrained = os.path.join(pretrained_dir, 'checkpoint_0{}.pth.tar'.format(epoch))
        acc1 = main_worker(args.gpu, ngpus_per_node, args)
        f = open(os.path.join(args.save_dir, 'record_acc.txt'), 'a')
        f.write('Epoch {} | Acc {}\n'.format(epoch, acc1))
        f.close()
